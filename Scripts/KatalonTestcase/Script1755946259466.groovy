...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_CURA Healthcare Service/select_Facility_combo_facility'), 
    'Hongkong CURA Healthcare Center', true)

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Facility_checkbox-inline'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/label_Medicare_radio-inline'))
...
WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_txt_comment'), 'test')

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/button_Comment_btn-book-appointment'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_CURA Healthcare Service/h2'), 'Appointment Confirmation')
